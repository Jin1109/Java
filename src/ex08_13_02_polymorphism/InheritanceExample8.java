...
public class InheritanceExample8 {
   ...
   /*
    	...
    	2. MessageSender 클래스에서 sendMessage 메ㅗ드를 주석 처리할 경우
    	   에러 발생합니다.
    	
    	3. 자바 컴파일러는 변수의 타입으로 그 메소드가 있는지 없는지 체크한다ㅣ.
    	   MessageSender에 senderMessage()메서드가 존재하지 않아서
    	   The method sendMessage(String) is underfined for the type
    	   에러가 발생했습니다.
