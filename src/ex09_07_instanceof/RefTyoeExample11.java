//instanceof 사용예 - 다운캐스팅 가능여부 확인
package ex09_07_instanceof;
class RefTyoeExample11 {
	public static void main(String[] args) {
		Account obj 
		= new CheckingAccount("111-22-33333333", "홍길동", 
				100000, "5555-6666-7777-8888");
		//Account obj = new CheckingAccount 변경
		
		//obj를 CheckingAcount로 캐스트 가능한 여부 확인((CheckingAccount) obj)
		if (obj instanceof CheckingAccount) {
			//obj를 CheckingAccount로 캐스트할 수 있을 대만 pay메서드 호출
