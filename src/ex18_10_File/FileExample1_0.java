...
//File 클래스 : 파일 관리 기능도 가지고 있습니다.
//%-25s : 25칸을 왼쪽으로 정렬
//%1$tF : YYY-mm-dd 포맷의 날짜
//%1$tT : HH:MM:SS 포맷
...
public class FileExample1_0 {
	public static void main(String[] args) {
		...
		File file = new File(".");//현재 디렉토리(.),상위렉토리(..)
		...
		for (int cnt = 0; cnt < arr.length; cnt++) {
			...
			//1970년 1월 1일 0시 0분 0초 기점으로 결과한 밀리세컨드 값을 리턴
			//사람이 이해할 수 있는 날짜와 시간으로 변결할 필요가 있습니다.
			long time = arr[cnt].lastModified();//최송 수정일시를 리턴
			//System.out.printf("%d\n", time);
