--실행 방법
--1. 한 문장 실행의 경우는 커서를 문장위에 놓고 마우스 우클릭->Excute Current Text(Alt + S)
drop table goodsinfo puruag;
...
insert into goodsinfo
values('10005',	'벽결이 에어컨',  400000, '삼성');

select * from goodsinfo;

select * from dept;

-- 3. 함수나 프로시저 처럼 세미클론으로 끝나는 여러 문자이 포함되는 경우
--	  영역 설정 후 마우스 우클릭 -> Excute Selected Text As One Statment(Alt+C)
